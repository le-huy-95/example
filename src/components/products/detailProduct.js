                                                ...
                                                <div className="order col-12 col-lg-3 mb-2">
                                                    ...
                                                    <div className='status-payment'>
                                                        {projects?.Status_Delivery
                                                            && projects?.Status_Delivery?.status ? projects?.Status_Delivery.status : "Chưa giao hàng"}
                                                    </div>
                                                </div>
                                                <hr className='d-block d-lg-none' />
                                                <div className="order col-12 col-lg-3 mb-2">
                                                    ...
                                                    <div className='status-SaleChannel'>
                                                        {
                                                            projects?.Status_Received_money?.status
                                                                ? projects?.Status_Received_money?.status : "Đang đối soát"}
                                                    </div>
                                                </div>
                                                    ...
                                                    <div className='table-primer '>
                                                        <div className='container'>
                                                            <div className=' title  mb-3'>
                                                                <div className='row'>
                                                                    <div className='title-left col-7 col-lg-11'>
                                                                        <h4 style={{ color: "#637381" }}>
                                                                            {t('detail.Status-payment.One')}
                                                                        </h4>
                                                                    </div>
                                                                    <div className='title-right col-5 col-lg-1 '>
                                                                        {actionModalThree === "3" ?
                                                                                    ...
                                                                                    <div className='container'>
                                                                                        <div className='row'>
                                                                                            ...
                                                                                            <input
                                                                                                ...
                                                                                                min="1" max="9999"
                                                                                                className="form-control mt-2 "
                                                                                                value={projects?.Shipping_Unit?.NameUnit}
                                                                            ...
                                                                            <div className='right-item col-12 col-xl-6 d-flex flex-column'>
                                                                                ...
                                                                                <div className='item-info py-1 '>
                                                                                    <div className='row '>
                                                                                        ...
                                                                                        <b className='item-info_value col-12 col-sm-6'>
                                                                                            {
                                                                                                projects?.Shipping_Unit?.NameUnit
                                                                                                    ? projects?.Shipping_Unit?.NameUnit
                                                                                                    : " Đang cập nhật"
                                                                                            }
                                                            ...
                                                            <div className='row d-flex align-items-center'>
                                                                ...
                                                                {actionModalFour === "4" ?
                                                                    ...
                                                                    <>
                                                                        ...
                                                                        <div className='d-none d-lg-block item col-1' onClick={() => handleEditActionFour()}>
                                                                                                ...
                                                                                                previewsImage.map((item, index) => {
                                                                                                    return (
                                                                                                        ...
                                                                                                        >
                                                                                                            ...
                                                                                                            <h5 class="card-title" onClick={() => handleDeleteImageAdd(item)}>
                                                                                                                <i class="fa fa-times-circle" aria-hidden="true"></i>
                                                                                                            </h5>
                                                                            ...
                                                                            <>
                                                                                <div className='chat-all-item col-12' key={`image-chat-${index}`}>
                                                                                    <div className='container'>
                                                                                        <div className="row">
                                                                                            {imagebase64 ?
                                                                                                <div className='image col-1 my-4 d-none d-sm-block'
                                                                                                    title="Xem chi tiết hình ảnh">
                                                                                                    <img src={imagebase64} alt="" />
